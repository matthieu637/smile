...
%  V = load('/home/matthieu/workspace/java/mountaincar/myData/slowS/slowS/correct140/avg_curve');
X = load('/home/matthieu/workspace/java/mountaincar/myData/slowS/slowS/advise40/avg_curve');
...
QQ=zeros(size(n,2), 2);
for i=n
    q = load( cstrcat('/home/matthieu/workspace/java/mountaincar/myData/slowS/slowS/advise',
		num2str(i),'/avg_curve'));
	QQ(k,1) = mean(q(:,2));
	QQ(k,2) = i;
	k = k +1;
